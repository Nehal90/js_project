...
public class LoginBO_V2 extends JFrame implements ActionListener // Implementing ActionListener is for event handling.
{
    ...
    public LoginBO_V2()
    {
        ...
        setSize(300, 200);
         ...
         JLabel FirstTimeUserLabel = new JLabel("First time user please click Sign Up to register!");
