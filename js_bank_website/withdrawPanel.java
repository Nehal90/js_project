   ...
   implements ListSelectionListener, ActionListener
{
   ...
   public withdrawPanel(String UName)
   {
	   Username=UName;
                    ...
                    if (amount.equals("") && account.equals(""))
                    	...
                    	JOptionPane.showMessageDialog(null, "Please enter the withdraw amount!", "Error", JOptionPane.INFORMATION_MESSAGE);
                		  					   ...
                		  					   System.out.println("Username: " + Username);
   					      					   System.out.println("w_frm: " +account);
   					      					   System.out.println("w_amount: " +amount);
   					      					   WithdrawControl WithdrawC = new WithdrawControl(Username, account, amount, type);}
