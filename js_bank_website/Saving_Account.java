...
public Saving_Account(String UN, String acct) {
		Username = UN;
		account=acct;
	}
public Saving_Account(String UN, String acct, String amt, String typ) {
		Username = UN;
		account = acct;
		amount = amt;
		type=typ;
...
public Saving_Account(String UN, String AccTo, String AccFm, String amt, String typ) {
		Username = UN;
		account1=AccFm;
		account2 = AccTo;
		amount=amt;
...
public int viewbalance() {
		...
		try {
		    if (done) {
		        ...
		        String SQL_Command = "SELECT Balance FROM Saving_Account WHERE Username ='"+Username+"'";
				...
				try {
				    if (done) {
				        ...
				        while(Rslt.next())
           			{
				        ...
				        String SQL_Command2 = "UPDATE Saving_Account SET Balance ="+currbalance+" WHERE Username ='"+Username+ "'"; //SQL query command
