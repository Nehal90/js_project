  ...
  public void actionPerformed(ActionEvent evt)  //event handling
   	         {
   	             ...
   	             if (source == transferButton)
   	                         ...
   	                         account1 =selectedSwingComponentTextField.getText();
				             account2 = selectedSwingComponentTextField2.getText();
				             type="Online Transfer";
                    if (amount.equals("") && account1.equals(""))
                    ...
                    else if (account1.equals(""))
                    	JOptionPane.showMessageDialog(null, "Please select an account!", "Error", JOptionPane.INFORMATION_MESSAGE);
                    else
                		{
   					       					      					   System.out.println("Username: " + Username);
					      					      					   System.out.println("t_frm: " + account1);
					      					      					   System.out.println("t_to: " + account2);
					      					      					   System.out.println("t_amount: " +amount);
   					      					   TransferControl TransferC = new TransferControl(Username, account1, account2, amount, type);}
   					   }
      ...
      private String account1, account2, amount, type;
}
