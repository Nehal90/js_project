...
public class DBConnection {
    ...
    public DBConnection() {
        URL = "jdbc:odbc:MS Access Database";
        //URL ="jdbc:sqlserver://127.0.0.1:1433;databaseName=Cargo;user=Tang;password=hifdu;";
        connection = null;
    ...
    public Connection openConn() {
        try {
            ...
            //connection = DriverManager.getConnection(URL, "Tang", "hifdu");
        }
        catch ( Exception e ) {
            e.printStackTrace();
            connection = null;
